...
$(EXE_REL): $(EXE_C) $(OBJDIR)/$(LIB)
	...
	$(VECHO) "CC  $<"
	$(Q)$(CC) $< $(CFLAGS) -L$(OBJDIR) -lhml_stc90 -o $(OBJDIR)/`$(BASENAME) $@`
...
help:
	...
	@$(ECHO) "Examples:"
	@$(ECHO) "    (1) make -j"
	@$(ECHO) "    (2) make -j MCU=stc90c52rc"
	@$(ECHO) "    (3) make rebuild MCU=stc90c52rc JOBS=4"
	@$(ECHO) "    (4) make -j library MCU=stc90c52rc"
# [+] library
.PHONY: library
library: $(OBJDIR)/$(LIB)
	@$(ECHO) ===================================================
...
version:
	...
	@$(ECHO) ""
	@$(ECHO) "Adapted for HML_FwLib_STC90 by Jiabin Hsu <zsiothsu@zhishan-iot.tk>"
